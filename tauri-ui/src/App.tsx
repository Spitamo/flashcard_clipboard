...
const REST_URL = "http://127.0.0.1:8000/flashcards";
    ...
    return (
      <div className="review">
        <div className="review-done">
          ...
          <button className="btn btn-skip" style={{ marginTop: 8 }}
  ...
  return (
    <div className="review">
      ...
      <div className="review-controls">
        <button className="btn btn-skip" onClick={next}>Skip</button>
        <button className="btn btn-know" onClick={markKnown}>I know this ✓</button>
      </div>
...
export default function App() {
  ...
  useEffect(() => {
    function connect() {
      ...
      ws.onmessage = (e) => {
        ...
        setCards(prev => {
          // avoid duplicates
          if (prev.some(c => c.source === card.source)) return prev;
          return [card, ...prev];
        });
      };
    }
  ...
  return (
    <>
      ...
      {tab === "feed"
        ? <Feed   cards={cards} connected={connected} />
        : <Review cards={cards} />}
    </>
  );
}